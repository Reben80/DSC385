...
Possibly interesting datasets:
https://www.kaggle.com/uciml/pima-indians-diabetes-database
(excellent, has license, but no missing values, no categories; also has no data dictionary)

https://www.kaggle.com/abcsds/pokemon
(excellent, has missing values, has license, has data dictionary, has no categories)
