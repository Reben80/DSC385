...
```{r boxoffice-axis-title, eval = FALSE}
ggplot(boxoffice) +
  aes(amount, fct_reorder(title, amount)) +
  geom_col() +
  scale_x____() +
...
```{r boxoffice-expansion, eval = FALSE}
...
```{r tx-counties-log-customize, eval = FALSE}
...
```{r temps-scatter-coord-fixed, eval = FALSE}
...
```{r temps-scatter-coord-fixed2, eval = FALSE}
...
```{r boxoffice-coord-xlims, eval = FALSE}
ggplot(boxoffice) +
  aes(amount, fct_reorder(title, amount)) +
  geom_col() +
  ___
