...
14.     Data quality and relevance  handling missing data, `is.na()`, `case_when()`

15.     Getting things into the     `fct_reorder()`, `fct_lump()`
        right order

16.     Visualizing proportions     bar charts, pie charts
